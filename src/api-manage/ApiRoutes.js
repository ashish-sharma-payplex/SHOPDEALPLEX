...
export const bug_report ="api/v1/bug-report";
export const job_apl ="api/v1/job-application";
...
export const parcel_category_api = "api/v1/customer/parcelapi/parcel-category";
...
export const common_condition_product_in_store =  "/api/v1/items/common-conditions";
export const wallet_transactions_list_api =  "/api/v1/customer/wallet/transactions";
export const LP_transactions_list_api =  "/api/v1/customer/loyalty-point/transactions";
export const Loyalty_points_transfer_api =  "/api/v1/customer/loyalty-point/point-transfer";
...
export const suggested_items_stores = "/api/v1/items/item-or-store-search"; //search box suggestion 
export const universal_search_box ="/api/v1/items/universal/item-or-store-search"; //universal search box
...
export const update_payment_method_api =  "/api/v1/customer/order/payment-method";
...
export const basic_campaigns_details_api =   "/api/v1/campaigns/basic-campaign-details";
...
export const toggle_review_status_api = "/api/v1/customer/order/toggle-review-status";

export const update_interest_api = "/api/v1/customer/update-interest";
export const landing_page_api = "/api/v1/react-landing-page"; //main landing page
