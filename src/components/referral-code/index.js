  ...
  return (
    <Box width="100%" display="flex" justifyContent="center" mt={3}>
      <Box width="100%" maxWidth="100%">
        {/* 🔹 Top Green Banner */}
        <Box position="relative" borderRadius="14px" overflow="hidden" mb={2}>
          <WalletBgSvg />
          <Stack position="relative" zIndex={1} p={2} spacing={1}>
            <Stack
              direction="row"
              alignItems="center"
        ...
        {/* 🔹 How It Works */}
        <Box borderRadius="14px" p={2} border={1} borderColor="divider">
