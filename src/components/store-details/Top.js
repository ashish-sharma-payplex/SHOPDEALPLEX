...
const Top = (props) => {
  ...
  const content = () => {
    if (isSmall) {
        ...
        <CustomStackFullWidth>
          ...
          <CustomStackFullWidth>
            ...
            >
              ...
              >
                {storeDetails && storeDetails.positive_rating !== undefined && storeDetails.positive_rating !== null && storeDetails.positive_rating !== 0 ? (
      ...
      return (
        <CustomStackFullWidth direction="column" marginTop="20px">
          <ContentWrapper>
            <CustomImageContainer
              src={bannerCover}
              width="100%"
