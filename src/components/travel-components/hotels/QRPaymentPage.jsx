...
const QRPaymentPage = ({
  ...
  hotelName, hotelLocation, checkInDay, checkInDate, checkOutDay, checkOutDate,
  roomFare, taxAmount, convenienceFee, totalPayable,
}) => {
        ...
        <Box sx={{ flex: 1, width: "100%", bgcolor: "#fff", borderRadius: "18px", border: `1px solid ${BORDER}`, p: { xs: 2.5, sm: 4 } }}>
          ...
          <Box sx={{ display: "flex", justifyContent: "center", mb: 2 }}>
            <Box sx={{
              ...
              border: `2px solid ${isExpired ? "#fecaca" : isCancelled ? BORDER : isSuccess ? "#bbf7d0" : BORDER}`,
              ...
              {initiating || !paymentData ? (
                ...
                <Box sx={{ position: "relative" }}>
                  ...
                  />
                  {isExpired && (
                    <Box onClick={onRetry} sx={{ position: "absolute", inset: 0, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 1, cursor: "pointer" }}>
        ...
        <Box sx={{ position: "fixed", inset: 0, zIndex: 1400, bgcolor: "rgba(0,0,0,0.4)", display: "flex", alignItems: "center", justifyContent: "center", p: 2 }}>
          <Box sx={{ bgcolor: "#fff", borderRadius: "18px", maxWidth: 300, width: "100%", p: 2.5, textAlign: "center", boxShadow: "0 24px 64px rgba(0,0,0,0.18)" }}>
            ...
            <Box sx={{ display: "flex", gap: 1 }}>
              ...
              <Button fullWidth onClick={() => { setShowCancelConfirm(false); onCancel(); }} disabled={cancelling} sx={{ bgcolor: "#ef4444", color: "#fff", textTransform: "none", fontSize: 13, fontWeight: 600, borderRadius: "8px", py: .9, "&:hover": { bgcolor: "#dc2626" } }}>
