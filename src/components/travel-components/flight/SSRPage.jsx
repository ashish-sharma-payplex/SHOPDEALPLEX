...
.seg-tabs{
        ...
        .meal-card{
          border:1.5px solid var(--fl-border);border-radius:10px;padding:14px 16px;cursor:pointer;
          transition:all 0.15s;display:flex;justify-content:space-between;align-items:center;
          background:var(--fl-surface);min-width:0;gap:10px;
        }
        ...
        .bag-card{
          border:1.5px solid var(--fl-border);border-radius:10px;padding:14px 16px;cursor:pointer;
          transition:all 0.15s;display:flex;align-items:center;gap:12px;background:var(--fl-surface);min-width:0;
        }
...
.trav-chip.active {
  border-color: var(--fl-brand-line);
            ...
            <div className="card">
              ...
              <div className="ssr-header">
                <div style={{ display: "flex", gap: 24, minWidth: 0 }}>
                  ...
                  <button
                    className={`tab-btn ${
                      activeTab === "baggage" ? "tab-active" : "tab-inactive"
                    }`}
                ...
                {!mealSelectionApplicable && (
                  ...
                  >
                    Skip to {activeTab === "meals" ? "Baggage" : "Seat"}{" "}
                    Selection <ChevronRight />
                  </button>
                )}
              </div>
              ...
              {mealSelectionApplicable && (
                ...
                >
                  🍽️ This airline requires a meal selection for every traveller
            ...
            <div className="card">
              ...
              <div style={{ padding: "16px 20px" }}>
                <button
                  ...
                  onMouseOver={(e) => {
                    if (mealSelectionComplete && !saving)
