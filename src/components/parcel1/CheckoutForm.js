          ...
          <Grid container spacing={4} wrap="nowrap">
            ...
            <Grid item sx={{ width: "62%" }}>
              <Card variant="outlined" sx={{ p: 3, borderRadius: 4 }}>
                ...
                {/* Address Details */}
                <Typography
                  sx={{ fontWeight: 600, mb: 2, fontFamily: "Inter", fontSize: "14px" }}
                >
                  Address Details
                </Typography>
                    ...
                    <Box flex={1}>
                      ...
                      <Box display="flex" justifyContent="space-between">
                        ...
                        <Typography
                          ...
                          sx={{ color: "#1f8f4a", fontSize: "12px", cursor: "pointer", fontFamily: "Inter" }}
                        >
                          Edit
                        </Typography>
                      </Box>
            ...
            <Grid item sx={{ width: "45%", fontFamily: "Inter" }}>
              <Typography
                sx={{ fontWeight: 600, mb: 2, fontSize: "14px", fontFamily: "Inter" }}
              >
                Select Vehicle
              </Typography>
              ...
              {vehicleLoading ? (
                ...
                <>
                  ...
                  {otherVehicles.length > 0 && (
                    <>
                      <Typography
                        sx={{ fontWeight: 600, mb: 1.5, fontSize: "14px", fontFamily: "Inter" }}
                      >
                        Others
                      </Typography>
