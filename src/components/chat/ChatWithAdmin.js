				...
				>
					<CustomStackFullWidth spacing={2}>
						...
						<Tooltip
							title={
								value === "" && text === ""
									? "Please enter a value and message"
									: ""
							}
							arrow
						>
							<span style={{ width: "100%" }}>
								<Button
									...
									sx={{
										...
										backgroundColor: "#1A914B !important", // Force green background
										opacity: "1 !important",

										"&:hover": {
											backgroundColor: "#1aaa56 !important",
										},

										// Sabse zaroori part yahan hai:
										"&.Mui-disabled": {
											backgroundColor: "#1A914B !important",
											color: "#ffffff !important",
											opacity: "1 !important",
											cursor: "not-allowed",
											pointerEvents: "auto",
											// Kabhi kabhi MUI button ke text (span) ki opacity kam kar deta hai
											"& .MuiTypography-root": {
												color: "inherit",
											}
										},
										// Kuch browsers me disabled button ke text ko grey karne ke liye ye lagta hai
										"&.Mui-disabled .MuiButton-label": {
											color: "#ffffff !important",
										},
										// Safari aur Chrome ke liye extra safety
