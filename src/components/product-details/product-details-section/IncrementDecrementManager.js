...
import { CustomFab, CustomStackFullWidth } from "../../../styled-components/CustomStyles.style";
...
const IncrementDecrementManager = (props) => {
  const { decrementQuantity, incrementQuantity, modalData, productUpdate } = props;
  ...
  return (
    <CustomStackFullWidth spacing={2}>
      <Stack direction="column" spacing={2} alignItems="flex-start">
        ...
        >
          <Stack direction="row" spacing={4} alignItems="center" width="100%" justifyContent="space-between">
            <Stack
              direction="row"
              alignItems="center"
              justifyContent="space-between" // Added spacing between the icons and the quantity
              sx={{
              ...
              borderRadius={
                getModule()?.module_type === "pharmacy" || getModule()?.module_type === "grocery"
                  ? "5px"
                  : "13%"
              }
              padding={
