...
const ProductInformationBottomSection = ({
  ...
  sx={{
    ...
    color: "#1A914B",          // Green text color
    border: `1px solid #1A914B`,  // Green border
    width: {
      xs: "100%",
      sm: productDetailsData?.isCampaignItem ? "100%" : 200,
    },
    "&:hover": {
      color: "#1A914B",  // Green text on hover
      backgroundColor: alpha("#1A914B", 0.1),  // Slightly tinted background on hover
    },
  }}
>
  ...
  sx={{
    backgroundColor: "#1A914B", // Set the background color to #1A914B
    ...
    "&:hover": {
      ...
      border:"1px solid #1A914B" // Keep the same background on hover
    },
  }}
>
  ...
  <PrimaryButton
    ...
    sx={{
      backgroundColor: "#1A914B", // Set the background color to #1A914B
      color: "white", // Text color remains black
      width: 200,
      fontSize: { xs: "12px", md: "14px" },
      "&:hover": {
        color: "#1A914B",
