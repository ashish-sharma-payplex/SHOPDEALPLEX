  ...
  return (
    <Box sx={{ padding: { xs: 2, md: 4 }, textAlign: "center", mb: 8 }}>
      ...
      <Typography
        ...
        sx={{ mb: 3, fontSize: 20 }}
      >
        We offer multiple vehicle types to match your delivery size, weight, and
        urgency.
      </Typography>
        ...
        {[
          {
            src: "/scooter.png",
            title: "2 Wheeler",
            desc: "Documents, small boxes, fast delivery up to 20 kg.",
          },
          {
            src: "/3wheeler.png",
            title: "3 Wheeler",
            desc: "For medium-weight goods, groceries, cartons, up to 500 kg.",
          },
          {
            src: "/4wheeler.png",
            title: "Mini Truck",
            desc: "Large items, small appliances, up to 750 kg load capacity.",
          },
          {
            src: "/truck.png",
            title: "Pickup Truck",
            desc: "Bulky parcels, furniture, commercial goods (1.5-3 Ton).",
          },
        ].map((item, index) => (
          <Grid item xs={12} sm={3} key={index} sx={{ display: "flex" }}>
            ...
            >
              ...
              <Typography
                ...
                fontFamily="Inter"
                fontWeight={500}
                className={isDark ? styles.accentGreenDark : undefined}
