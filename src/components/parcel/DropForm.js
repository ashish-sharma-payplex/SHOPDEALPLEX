  ...
  const [sameAsSender, setSameAsSender] = useState(() => {
    ...
    try {
      const session = JSON.parse(
        localStorage.getItem("parcel_booking_session") || "{}",
      );
  ...
  const handleConfirm = () => {
    ...
    if (
      ...
      errors.receiver_contact_no =
        "Receiver number cannot be same as sender number";
    }
            ...
            >
              ...
              <TextField
                ...
                helperText={
                  ...
                  "Use the map on right to search & select drop location"
                }
