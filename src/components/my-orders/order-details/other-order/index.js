...
const OtherOrder = (props) => {
  const { configData, data, refetch, id, dataIsLoading, page, driverLocation } = props;
...
// console.log("order data of my order ",data)
// console.log("📍 driverLocation in OtherOrder:", driverLocation)
