      ...
      {visitedStores?.length > 0 && token && (
        ...
        >
          {IsSmallScreen() ? (
            ...
            <>
              <H1 text={getModuleWiseData?.()?.heading} component="h2"  textTransform= "uppercase"  letterSpacing="1px" color= "#d72a00"/>
              {isVisited && (
                <Subtitle1
                  text={getModuleWiseData?.()?.subHeading}
                  component="p"
          ...
          <SliderCustom
            nopadding="true"
            sx={{
              background: "linear-gradient(180deg, rgb(255, 145, 0) 0%, rgb(255, 159, 28) 100%);", // Gradient background for parent container
              padding: { xs: "0px", md: "27px" },
            }}
          >
            <Slider {...settings}>
