...
>
  <Button
    ...
    sx={{
      ...
      fontSize: "14px",
      borderRadius: 1,
      backgroundColor: "#1A914B", // ✅ Yes, Cancel button green
      "&:hover": {
        backgroundColor: "#15803d", // thoda dark green hover
      },
    }}
  >
  ...
  <Button
    ...
    sx={{
      ...
      fontSize: "14px",
      borderRadius: 1,
      backgroundColor: (theme) => theme.palette.error.main, // ❌ Cancel button unchanged
      "&:hover": {
