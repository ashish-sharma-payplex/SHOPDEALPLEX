  ...
  return (
    ...
    >
      ...
      >
        ...
        <Typography
          sx={{ fontSize: 13, color: "var(--ut-text-6b7280)", mb: 2.5 }}
        >
        ...
        <Box
          sx={{
            border: "1px solid var(--ut-border-d1fae5)",
            borderRadius: "16px",
            p: 2.5,
            mb: 2.5,
            position: "relative",
            overflow: "hidden",
            background:
              "linear-gradient(to right, var(--ut-bg-e8faf0) 0%, var(--ut-bg-f4fdf7) 40%, transparent 100%)",
          }}
        >
          ...
          >
            ...
            <Box
              sx={{
                ...
                border: "1px solid var(--ut-border-bbf7d0)",
                borderRadius: "20px",
                px: 1.2,
                py: 0.3,
              }}
          ...
          {/* Available Balance */}
          <Typography
            sx={{ fontSize: 13, color: "var(--ut-text-6b7280)", mb: 0.4 }}
          >
            Available Balance
          </Typography>
          <Typography
          ...
          {/* Dashed divider */}
          <Box
            sx={{ borderTop: "1.5px dashed var(--ut-border-e5e7eb)", mb: 1.5 }}
          />
      ...
      >
        ...
        <Box
          sx={{
            p: { xs: 2, sm: 2.5 },
            borderBottom: "1px solid var(--ut-border-e5e7eb)",
          }}
        >
          <Typography
            sx={{ fontSize: 13, color: "var(--ut-text-6b7280)", mb: 0.3 }}
          >
            Total Amount
          </Typography>
          <Typography
          ...
          >
            <Box>
              ...
              <Typography sx={{ fontSize: 14, color: "var(--ut-text-111111)" }}>
                {billerName}
              </Typography>
            </Box>
            <Box>
        ...
        <Box sx={{ p: { xs: 2, sm: 2.5 } }}>
          ...
          >
            <Typography sx={{ fontSize: 13, color: "var(--ut-text-374151)" }}>
              Base Amount
            </Typography>
            <Typography sx={{ fontSize: 13, color: "var(--ut-text-374151)" }}>
              ₹{baseAmount}
          ...
          <Box
            sx={{ borderTop: "1px dashed var(--ut-border-e5e7eb)", mb: 1.5 }}
          />
