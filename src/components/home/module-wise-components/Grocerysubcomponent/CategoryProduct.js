                      ...
                      subcats.map((sub) => (
                        <Chip
                          ...
                          sx={{
                            ...
                            backgroundColor:
                              activeId === sub.id
                                ? "var(--grocery-cta-green) !important"
                                : "var(--bg-card) !important",
                            color:
                              activeId === sub.id
                                ? "var(--grocery-text-on-brand) !important"
                                : "var(--text-primary)",
                            border: "1px solid var(--grocery-cta-green)",
                            borderRadius: "8px",
                            "&:hover": {
                              backgroundColor:
                                activeId === sub.id
                                  ? "var(--grocery-cta-green)"
                                  : "var(--brand-green-soft) !important",
                            },
                          }}
                        />
                      ))
