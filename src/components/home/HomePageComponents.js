...
const HomePageComponents = ({ configData, landingPageData }) => {
	...
	// console.log("config data of homepagrcompo :", configData)
	// console.log("landing page data of homepagrcompo :", landingPageData)
	return (
		<PushNotificationLayout>
			<CustomStackFullWidth>
				<CustomStackFullWidth sx={{ position: "relative" }}>
					{moduleType === ModuleTypes.RENTAL && <TopBanner />}
					<CustomStackFullWidth
						alignItems="center"
