  ...
  return (
    <Card
      ...
      sx={{
        ...
        borderLeft: "4px solid var(--mb-danger-text)",
        borderRadius: "14px",
        ...
        <Box sx={{ display: "flex", alignItems: "center", gap: 1, mb: 1.5 }}>
          <Box
            sx={{
              ...
              height: 34,
              borderRadius: "50%",
              bgcolor: "var(--mb-danger-bg-strong)",
              display: "flex",
              alignItems: "center",
          ...
          >
            <CancelOutlinedIcon
              sx={{ fontSize: 18, color: "var(--mb-danger-text)" }}
            />
          </Box>
...
const ChangeRequestRow = ({ request }) => {
  ...
  const listStatusMeta =
    CHANGE_REQUEST_STATUS[request.change_request_status] ||
    DEFAULT_CHANGE_REQUEST_STATUS;
        ...
        html: `
          <div style="text-align:left; font-family:inherit;">
            ...
            <table style="width:100%; border-collapse:collapse; font-size:13px;">
              <tr>
                <td style="padding:6px 0; color:var(--mb-text-faint);">Trace ID</td>
                <td style="padding:6px 0; font-weight:700; text-align:right;">${
                  data.trace_id ?? "—"
                }</td>
              </tr>
              <tr>
                <td style="padding:6px 0; color:var(--mb-text-faint);">Change Request ID</td>
                <td style="padding:6px 0; font-weight:700; text-align:right;">${
                  data.change_request_id ?? "—"
                }</td>
              </tr>
              <tr>
                <td style="padding:6px 0; color:var(--mb-text-faint);">Ticket ID</td>
                <td style="padding:6px 0; font-weight:700; text-align:right;">${
                  data.ticket_id ?? "—"
                }</td>
              </tr>
              <tr>
                <td style="padding:6px 0; color:var(--mb-text-faint);">Cancellation Charge</td>
                <td style="padding:6px 0; font-weight:700; text-align:right;">${money(
                  data.cancellation_charge,
                )}</td>
              </tr>
              <tr>
                <td style="padding:6px 0; color:var(--mb-text-faint);">Refunded Amount</td>
          ...
          data.refunded_amount,
            ...
            ${
              data.message
                ? `<div style="margin-top:14px; padding:10px 12px; background:var(--mb-surface-subtle); border-radius:8px; font-size:12.5px; color:var(--mb-text-body);">
                     ${data.message}
                   </div>`
                : ""
            }
    ...
    <Box sx={{ display: "flex", flexDirection: "column", gap: 0.6 }}>
      ...
      >
        <Box sx={{ minWidth: 0 }}>
          ...
          <Typography
            sx={{ fontSize: 11, color: "var(--mb-text-faint)", mt: 0.25 }}
          >
            {REQUEST_TYPE_LABELS[request.request_type] || "Cancellation"} ·{" "}
