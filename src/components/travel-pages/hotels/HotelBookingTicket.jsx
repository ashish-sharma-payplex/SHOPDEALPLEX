  ...
  >
    ...
    <Box
      sx={{
        ...
        height: 32,
        borderRadius:
          "0 50% 50% 0" /* Only RIGHT half is rounded = left side carved in */,
        bgcolor: BG,
        zIndex: 10,
      }}
    />
    ...
    <Box
      sx={{
        ...
        height: 32,
        borderRadius:
          "50% 0 0 50%" /* Only LEFT half is rounded = right side carved in */,
        bgcolor: BG,
        zIndex: 10,
      }}
    />
    ...
    <Box
      sx={{
        flex: 1,
        borderTop: "2px dashed var(--ht-border-strong)",
        mx: 0,
        position: "relative",
        zIndex: 1,
      }}
...
const GuestRow = ({ guest, index }) => {
  ...
  return (
    ...
    >
      <Box
        sx={{ display: "flex", alignItems: "center", gap: 0.8, minWidth: 0 }}
      >
        <PersonOutlineOutlinedIcon
          sx={{ fontSize: 15, color: LIGHT, flexShrink: 0 }}
        />
        <Typography
          sx={{
            fontSize: 13,
      ...
      <Chip
        label={
          isChild ? `Child${guest.age ? ` · ${guest.age}y` : ""}` : "Adult"
        }
        size="small"
        sx={{
          height: 20,
          ...
          fontWeight: 700,
          fontFamily: FONT,
          bgcolor: isChild ? "var(--ht-warn-bg)" : "var(--ht-info-bg)",
          color: isChild ? "var(--ht-warn-strong-text)" : "var(--ht-info-text)",
          flexShrink: 0,
        }}
      />
    </Box>
...
const HotelBookingTicket = () => {
  ...
  const guestName =
    ...
    (passengers.find((p) => p.isLead)?.firstName
      ? `${passengers.find((p) => p.isLead).firstName} ${
          passengers.find((p) => p.isLead).lastName ?? ""
        }`.trim()
      : "");
    ...
    >
      ...
      >
        ...
        <Box sx={{ px: 2.5, pt: 2, pb: 2 }}>
          ...
          <Divider sx={{ my: 1.5, borderColor: "var(--ht-border-soft)" }} />
