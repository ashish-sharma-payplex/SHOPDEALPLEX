// src\styled-components\CustomStyles.style.js
import {
	Alert,
	alpha,
	Badge,
		...
		boxShadow:
			noboxshadow === "true"
				...
				: theme.palette.mode === "light"
					? `0px 0px 2px rgba(145, 158, 171, 0), 0px 5px 20px ${theme.palette.paperBoxShadow}`
					: "none",
		// marginBottom: '30px',
	})
);
...
export const CustomCarouselWrapper = styled("div")(({ theme, backgroundImage }) => ({
	position: "relative",
	width: "100%",
	height: "300px",
	backgroundImage: `url(${backgroundImage})`, // Default image
	backgroundSize: "cover",
	backgroundPosition: "center",
	backgroundRepeat: "no-repeat", // Set desired height for carousel
