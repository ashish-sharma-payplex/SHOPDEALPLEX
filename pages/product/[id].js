...
const Index = ({ configData, productDetailsData, landingPageData }) => {
  ...
  useEffect(() => {
    // console.log("Client-side Config Data:", configData);
    // console.log("Client-side Product Details Data:", productDetailsData);
  }, []);
  ...
  return (
    <>
      ...
      <SEO
        ...
        image={productDetailsData?.image_full_url || `${configData?.base_urls?.item_image_url || "/default-image-path"}/${productDetailsData?.image}`}
