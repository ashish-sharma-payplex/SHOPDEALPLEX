...
const Faq = ({ configData, landingPageData }) => {
  ...
  const dummyFaqs = useMemo(() => [
    ...
    {
      question: "What is the typical delivery time for grocery orders?",
      answer: "Dealplex aims for delivery within 10–30 minutes for nearby dark stores, depending on your location, order size, and item availability. Exact estimated delivery time is displayed before you place the order.",
      category: "Grocery",
    },

    {
      question: "Is there a delivery fee on grocery orders?",
      answer: "A small delivery or handling fee may apply based on order value and distance. The exact fee is always shown at checkout before you confirm your order. Many stores offer free delivery above a minimum cart value.",
      category: "Grocery",
    },

    {
      question: "Can I schedule a grocery delivery for later instead of instant delivery?",
      answer: "Yes, where available, you can choose a scheduled delivery slot instead of instant delivery, which is useful for planned weekly or bulk grocery orders.",
      category: "Grocery",
    },
...

    {
      ...
      answer: "You can cancel from the Orders section as long as the order has not been packed or dispatched. Once it is out for delivery, cancellation may not be possible.",
      category: "Grocery",
    },

    {
      question: "What is the return or refund policy for grocery items?",
      answer: "Damaged, expired, or incorrect items can be reported within a short window after delivery through the app, and you will be offered a replacement or refund after verification.",
      category: "Grocery",
    },
  ...
  // ✅ FAQ Schema for SEO rich snippets (auto-generated from dummyFaqs)
  const faqSchema = useMemo(
    () => ({
      "@context": "https://schema.org",
      "@type": "FAQPage",
      mainEntity: dummyFaqs.map((faq) => ({
        "@type": "Question",
